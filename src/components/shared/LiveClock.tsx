...
export const LiveTime = () => {
    ...
    return (
        <div className="flex h-10 items-center justify-center rounded-full border border-border/40 bg-background/5 backdrop-blur-xl px-4 text-xs font-mono shadow-ultimate">
